    ...
    if((out = checkcircle(source_str, v)) != 0) {
        switch(out) {
            ...
            case 2:
                ...
                break;
            case 3:
                printf("Error.3. Invalid input: expected space after first coordinate\n");
                break;
            case 4:
                printf("Error.4. Invalid input: expected space or \",\" after second "
                   "coordinate\n");
                break;
            case 5:
                ...
                break;
            case 6:
                printf("Error.6. Invalid input: expected space or \")\" after radius\n");
                break;
            case 7:
